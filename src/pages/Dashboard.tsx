          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                  ...
                  {proximasAtividades.map((atividade, index) => (
                    <div key={index} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                      ...
                      <button 
                        ...
                        onClick={() => {
                          if (atividade.tipo === 'Simulado') setCurrentView('simulados');
                          else if (atividade.tipo === 'Flashcards') setCurrentView('flashcards');
                        }}
                      >
                        Iniciar
                      </button>
            ...
            <div className="simple-card">
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem', marginTop: '1rem' }}>
                ...
                >
                  <div>
                    <div style={{ fontWeight: '600', marginBottom: '0.5rem' }}>📚 Flashcards</div>
                    <div style={{ fontSize: '0.9rem', color: 'var(--text-secondary)' }}>Sistema de repetição espaçada</div>
                  </div>
                </button>
                ...
                >
                  <div>
                    <div style={{ fontWeight: '600', marginBottom: '0.5rem' }}>📝 Simulados</div>
                    <div style={{ fontSize: '0.9rem', color: 'var(--text-secondary)' }}>Questões e provas</div>
                  </div>
                </button>
                ...
                >
                  <div>
                    <div style={{ fontWeight: '600', marginBottom: '0.5rem' }}>🧠 Técnica Feynman</div>
                    <div style={{ fontSize: '0.9rem', color: 'var(--text-secondary)' }}>Explique para aprender</div>
                  </div>
                </button>
                ...
                >
                  <div>
                    <div style={{ fontWeight: '600', marginBottom: '0.5rem' }}>📄 Editor de Resumos</div>
                    <div style={{ fontSize: '0.9rem', color: 'var(--text-secondary)' }}>Crie resumos em Markdown</div>
                  </div>
                </button>
                ...
                >
                  <div>
                    <div style={{ fontWeight: '600', marginBottom: '0.5rem' }}>📚 Biblioteca PDF</div>
                    <div style={{ fontSize: '0.9rem', color: 'var(--text-secondary)' }}>Visualize materiais</div>
                  </div>
                </button>
              </div>
            </div>
      ...
      {currentView !== 'dashboard' && (
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
            <button 
              className={currentView === 'flashcards' ? 'simple-btn' : 'simple-btn-outline'} 
              onClick={() => setCurrentView('flashcards')}
            ...
            <button 
              className={currentView === 'simulados' ? 'simple-btn' : 'simple-btn-outline'} 
              onClick={() => setCurrentView('simulados')}
              style={{ padding: '0.5rem 1rem', fontSize: '0.9rem' }}
            >
              Simulados
            ...
            <button 
              className={currentView === 'feynman' ? 'simple-btn' : 'simple-btn-outline'} 
              onClick={() => setCurrentView('feynman')}
              style={{ padding: '0.5rem 1rem', fontSize: '0.9rem' }}
            >
              Feynman
            ...
            <button 
              className={currentView === 'resumos' ? 'simple-btn' : 'simple-btn-outline'} 
              onClick={() => setCurrentView('resumos')}
              style={{ padding: '0.5rem 1rem', fontSize: '0.9rem' }}
            >
              Resumos
